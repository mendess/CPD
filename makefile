...
SOURCES_COMMON = $(wildcard $(SOURCES_COMMON_DIR)/*.cpp)
SOURCES_SERIAL = $(wildcard $(SOURCES_SERIAL_DIR)/*.cpp)
SOURCES_OPENMP = $(wildcard $(SOURCES_OPENMP_DIR)/*.cpp)
SOURCES_MPI    = $(wildcard $(SOURCES_MPI_DIR)/*.cpp)

OBJ_DEBUG_COMMON = $(foreach o, $(patsubst $(SOURCES_COMMON_DIR)/%.cpp, %.o, $(SOURCES_COMMON)), $(DEBUG_DIR_COMMON)/$o)
OBJ_DEBUG_SERIAL = $(foreach o, $(patsubst $(SOURCES_SERIAL_DIR)/%.cpp, %.o, $(SOURCES_SERIAL)), $(DEBUG_DIR_SERIAL)/$o)
OBJ_DEBUG_OPENMP = $(foreach o, $(patsubst $(SOURCES_OPENMP_DIR)/%.cpp, %.o, $(SOURCES_OPENMP)), $(DEBUG_DIR_OPENMP)/$o)
OBJ_DEBUG_MPI    = $(foreach o, $(patsubst $(SOURCES_MPI_DIR)/%.cpp, %.o, $(SOURCES_MPI)), $(DEBUG_DIR_MPI)/$o)

OBJ_RELEASE_COMMON = $(foreach o, $(patsubst $(SOURCES_COMMON_DIR)/%.cpp, %.o, $(SOURCES_COMMON)), $(RELEASE_DIR_COMMON)/$o)
OBJ_RELEASE_SERIAL = $(foreach o, $(patsubst $(SOURCES_SERIAL_DIR)/%.cpp, %.o, $(SOURCES_SERIAL)), $(RELEASE_DIR_SERIAL)/$o)
...
$(DEBUG_DIR_COMMON)/%.o: $(SOURCES_COMMON)
	$(CC) $(patsubst %.o, %.cpp, $(patsubst $(DEBUG_DIR_COMMON)/%, $(SOURCES_COMMON_DIR)/%, $@)) $(CFLAGS) $(DFLAGS) -I$(HEADERS_COMMON) -c -o $@

$(DEBUG_DIR_SERIAL)/%.o: $(SOURCES_SERIAL) $(SOURCES_COMMON)
	$(CC) $(patsubst %.o, %.cpp, $(patsubst $(DEBUG_DIR_SERIAL)/%, $(SOURCES_SERIAL_DIR)/%, $@)) $(CFLAGS) $(DFLAGS) -I$(HEADERS_COMMON) -I$(HEADERS_SERIAL) -c -o $@

$(DEBUG_DIR_OPENMP)/%.o: $(SOURCES_OPENMP) $(SOURCES_COMMON)
	$(CC) $(patsubst %.o, %.cpp, $(patsubst $(DEBUG_DIR_OPENMP)/%, $(SOURCES_OPENMP_DIR)/%, $@)) $(CFLAGS) $(DFLAGS) -I$(HEADERS_COMMON) -I$(HEADERS_OPENMP) -c -o $@

$(DEBUG_DIR_MPI)/%.o: $(SOURCES_MPI) $(SOURCES_COMMON)
	$(CC) $(patsubst %.o, %.cpp, $(patsubst $(DEBUG_DIR_MPI)/%, $(SOURCES_MPI_DIR)/%, $@))       $(CFLAGS) $(DFLAGS) -I$(HEADERS_COMMON) -I$(HEADERS_MPI)    -c -o $@


$(RELEASE_DIR_COMMON)/%.o: $(SOURCES_COMMON)
	$(CC) $(patsubst %.o, %.cpp, $(patsubst $(RELEASE_DIR_COMMON)/%, $(SOURCES_COMMON_DIR)/%, $@)) $(CFLAGS) $(RFLAGS) -I$(HEADERS_COMMON) -c -o $@

$(RELEASE_DIR_SERIAL)/%.o: $(SOURCES_SERIAL) $(SOURCES_COMMON)
	$(CC) $(patsubst %.o, %.cpp, $(patsubst $(RELEASE_DIR_SERIAL)/%, $(SOURCES_SERIAL_DIR)/%, $@)) $(CFLAGS) $(RFLAGS) -I$(HEADERS_COMMON) -I$(HEADERS_SERIAL) -c -o $@

$(RELEASE_DIR_OPENMP)/%.o: $(SOURCES_OPENMP) $(SOURCES_COMMON)
	$(CC) $(patsubst %.o, %.cpp, $(patsubst $(RELEASE_DIR_OPENMP)/%, $(SOURCES_OPENMP_DIR)/%, $@)) $(CFLAGS) $(RFLAGS) -I$(HEADERS_COMMON) -I$(HEADERS_OPENMP) -c -o $@

$(RELEASE_DIR_MPI)/%.o: $(SOURCES_MPI) $(SOURCES_COMMON)
	$(CC) $(patsubst %.o, %.cpp, $(patsubst $(RELEASE_DIR_MPI)/%, $(SOURCES_MPI_DIR)/%, $@))       $(CFLAGS) $(RFLAGS) -I$(HEADERS_COMMON) -I$(HEADERS_MPI) -c -o $@
